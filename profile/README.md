...
3. The use of computation was already widespread when I began my career as an undergraduate at Berkeley's [Center for Ethnographic Research](https://issi.berkeley.edu/cer/about). This is seen not only in computer-assisted qualitative data analysis software (CAQDAS), or the [proliferation of AI](https://www.cultureofmedicine.org/blog/a-silicon-cage-qualitative-research-in-the-era-of-ai), but in myriad digital tools we use even for methods assumed to be analog (like ethnography). The contours of algorithmic/ordinal society shape our work in ways both overt and subtle—grammar checkers and auto-complete suggestions, how books and articles get indexed in libraries, sorting algorithms in web searches, targeted marketing and news feeds that shape our perceptions and mood, chatbots, and deepfakes. This makes [thoughtful use](https://osf.io/preprints/socarxiv/7bsgy_v1), and perhaps social scientific inquiry using ethnography to understand life in situ, more important than ever—and has parallels to how thinkers radically repurposed bureaucratic technologies to [facilitate imaginative social inquiry](https://contexts.org/blog/soc-ai/) in previous eras.  
